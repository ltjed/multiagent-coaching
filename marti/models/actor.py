...
class Actor(nn.Module):
    ...
    def forward(
        ...
        # DEBUG: Print logits shape before log_softmax
        logits_shape = output["logits"].shape
        logits_memory_gb = (logits_shape[0] * logits_shape[1] * logits_shape[2] * 2) / 1e9
        print(f"[DEBUG Actor.forward] logits.shape={logits_shape}, estimated_memory={logits_memory_gb:.2f}GB")
